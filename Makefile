...
embassy-pages.s9pk: manifest.yaml config_spec.yaml config_rules.yaml images/image.tar instructions.md $(ASSET_PATHS)
	embassy-sdk pack

images/image.tar: Dockerfile docker_entrypoint.sh
